            ...
            <div className="flex flex-wrap items-center gap-2 text-sm">
              ...
              <div ref={accountRef} className="relative">
                ...
                >
                  ...
                  <svg viewBox="0 0 20 20" aria-hidden="true" className={`h-3 w-3 transition ${accountOpen ? "rotate-180" : ""}`} style={{ color: "var(--icon-accent)" }}>
                    <path fill="currentColor" d="M5.5 7.5 10 12l4.5-4.5" />
                  </svg>
                </button>

                {accountOpen ? (
                  <div className="absolute right-0 top-[calc(100%+8px)] z-20 w-44 rounded-xl border p-1.5 shadow-[0_18px_40px_var(--shadow)]" style={{ borderColor: "var(--border)", background: "var(--surface-strong)" }}>
                    <button
                      type="button"
                      onClick={async () => {
